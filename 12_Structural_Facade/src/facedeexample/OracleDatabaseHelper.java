...
public class OracleDatabaseHelper extends Database implements DatabaseTypeHelper{
	...
	public Connection  getConnection() {
		...
		database.setDriverName("oracle.jdbc.driver.OracleDriver");
		database.setConnectionString("jdbc:oracle:thin:@localhost:1521:xe");
